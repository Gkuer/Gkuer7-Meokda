...
<h4> 1) NAVBAR : 모두 링크연결 하였으며, 기존 인스타그램이나 페이스북과 동일한 기능을 제공합니다. 하지만, 검색기능은 활성화하지 않았습니다. <br><br>2) 사용자 현위치 기준 Map과 로드뷰를 출력하였습니다. 동시에, 현재 좌표를 함께 볼 수 있도록 구성하였습니다. <br><br> 3)  스크롤은 Infinite Scroll을 적용하여 무한으로 내리면서 영상을 감상할 수 있도록 구성하였고, 동영상을 사용자 현위치 기반 거리순으로 정렬하려고 하였으나 해당 부분 성공하지 못했습니다.<br><br> 4) 동영상은 모두 자동재생으로 시청할 수 있으며, Scroll이 내려옴과 동시에 화면에 출력되는 동영상이 재생될 수 있도록 개발하였습니다. <br><br> 5) 동영상을 한번 누르면 소리가 켜지고, 다시 누르면 소리가 꺼지도록 구성하였으며, 소리가 켜진 상태에서 스크롤을 내리면 소리가 자동으로 꺼지도록 개발하였습니다. <br><br>6) 다만, Infinite Scroll과 소리재생,멈춤, Scroll Top을 이용한 동영상 자동 재생,정지가 복합적으로 간헐적인 버그를 일으키고 있으며, 이부분 해결하지 못하였습니다. <br><br>7) 가게명을 클릭할 시, 네이버 지도에 해당 가게로 이동하도록 링크하여 사용자가 바로 다음 작업을 진행할 수 있도록 만들었습니다. 또한, 게시자의 아이디를 클릭할 시에는 해당 게시자의 프로필로 이동합니다.</h4><br><br>
...
<h3> 모든 개발은 혼자 진행하였으며,<br> 해당 프로젝트의 저작권은 작성자에게 있습니다. </h3><br>
